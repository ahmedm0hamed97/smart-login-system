...
function signUp(){
    ...
    function addData() {
        if(userNameSignUpInput.value=="" || userEmailSignUpInput.value=="" || userPassSignUpInput.value==""){
...
function enterHome(){
    ...
    document.getElementById('homeMessage').innerHTML = `welcome ${localStorage.getItem('currentUser')}`;
